...
[![PyPI](https://img.shields.io/pypi/v/cognis-iso20022.svg)](https://pypi.org/project/cognis-iso20022/)
[![CI](https://github.com/cognis-digital/iso20022/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/iso20022/actions)
...
ISO20022 exists for one job — validates, lints, and diffs iso 20022 / pacs / camt payment messages and translates legacy mt into mx with schema-aware errors. — and does it without a SaaS bill or heavyweight setup.
...
```bash
iso20022 --version
iso20022 scan .                      # scan the current project
iso20022 scan . --format json
iso20022 scan . --fail-on high       # non-zero exit for CI gates
iso20022 mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Prowide ISO 20022 / py-iso20022**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`iso20022` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
