#!/usr/bin/env sh
# Universal installer for iso20022. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/iso20022.git"
echo "Installing iso20022 ..."
