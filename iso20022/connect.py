"""Native cognis-connect emit for iso20022 — forward findings to any platform.

Maps iso20022's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    iso20022 ... --format json | iso20022-emit --to stix
    iso20022-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
